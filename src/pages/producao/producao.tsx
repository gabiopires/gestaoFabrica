...
import ListaDeProducao from '@/components/Producao/ListaDeProducao';
  ...
  return (
    <div>
      ...
      <div className='flex flex-col justify-center items-center p-5'>
        <div className='versaoTela'>Versão da Tela: {Configuracao.versaoProducaoPedidoMES}</div>
        <div className='flex justify-center items-center'><Image width={0} height={0} alt='' className='iconeTitulo' src="/images/robo.svg"/><h1 className='text-3xl'>Acompanhamento de Produção - MES</h1></div>
