...
interface BotaoOperListaProdutosProps{
    icone:string;
    id:any;
    tipo:string;
    funcao:any;
...
function btnEditar(id:any,icone:string,path:string,title:string,prio:string){
    return(
        ...
        >
            <Image width={0} height={0} alt='' className="cursor-pointer" src={icone} title={title} data-prio={prio}/>
        </Link>
    )
}
...
export default function BotaoOperListaProdutos(props:BotaoOperListaProdutosProps){
    return (
        <>
